# Ross Butler's Engineering Blog

This repository hosts my engineering blog which can be found at [rwbutler.github.io](https://rwbutler.github.io). It uses [Jekyll](https://jekyllrb.com) to transform posts written in [Markdown](https://en.wikipedia.org/wiki/Markdown) into a static website hosted on [GitHub Pages](https://pages.github.com).

## Credits

The theme applied to Jekyll is [Beautiful Jekyll](https://deanattali.com/beautiful-jekyll/) by [Dean Attali](https://twitter.com/daattali).
